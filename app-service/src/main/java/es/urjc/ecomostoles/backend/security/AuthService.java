 ...
 * 
 * Handles the registration of new tenants, encrypts their credentials securely
 * using BCrypt,
 * and authenticates existing tenants using the centralized
 * AuthenticationManager before
...
public class AuthService {
        ...
        /**
         * Authenticates a user against the DB and issues a JWT token if credentials are
         * valid.
         */
