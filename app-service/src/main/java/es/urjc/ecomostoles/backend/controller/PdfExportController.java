 ...
 *
 * <p>
 * This controller is the integration boundary between app-service and the
 ...
 * the correct {@code Content-Type} and {@code Content-Disposition}
 * headers.</li>
 * </ol>
 *
 * <p>
 * The utility-service base URL is externalised to
 * {@code application.properties}
 * via {@code utility.service.url} so it can be overridden per environment
 * (dev → localhost:8081, prod → internal DNS name).
 * </p>
 */
@RestController
public class PdfExportController {
        ...
        private static final DateTimeFormatter PDF_DATE_FMT = DateTimeFormatter
                        .ofPattern("dd 'de' MMMM 'de' yyyy, HH:mm", Locale.of("es", "ES"));
         ...
         *
         * <p>
         * Access is restricted to parties directly involved in the agreement
         * (origin or destination company) or platform ADMIN accounts.
         * </p>
         *
        ...
        public ResponseEntity<byte[]> generateAgreementPdf(
                ...
                boolean isOwner = (agreement.getOriginCompany() != null
                                ...
                                || (agreement.getDestinationCompany() != null
                                                && agreement.getDestinationCompany().getContactEmail()
