...
El diagrama de navegación adjunto ilustra la estructura de vistas de la plataforma y el flujo del usuario. Para facilitar su comprensión y demostrar el cumplimiento de los requisitos de seguridad, las rutas se han clasificado mediante un código de colores en tres zonas de acceso:

**1. Flujo Público (Flechas Azules 🔵 - Acceso Universal)**
Representa la zona accesible sin autenticación. Desde la página principal (`index.html`), cualquier visitante puede dirigirse a las pasarelas de acceso y creación de cuenta (`login.html` y `registro.html`).

**2. Flujo B2B (Flechas Amarillas 🟡 - Empresas Registradas)**
Es el núcleo operativo del sistema, exclusivo para empresas autenticadas. El `dashboard.html` actúa como panel central. Desde aquí, las flechas amarillas trazan las rutas que permiten a las empresas operar su propio ciclo de negocio (CRUD completo): publicar y gestionar sus ofertas (`mis_activos`), sus demandas (`mis_demandas`), cerrar tratos (`mis_acuerdos`), editar su perfil y utilizar el sistema de mensajería privada.

**3. Flujo de Administración (Flechas Verdes 🟢 - Supervisión)**
Rutas de máxima seguridad restringidas al rol de Administrador. Conectan directamente con el `admin_panel.html`, desde donde se ramifica el acceso a la gestión absoluta del sistema: moderación de usuarios, auditoría de transacciones, generación de reportes (PDF) y ajustes globales.

> **💡 Notas Arquitectónicas:**
>
> - **Accesibilidad Global:** Las vistas de `terminos.html` y `privacidad.html` se han aislado visualmente en el esquema (Global Footer), ya que son accesibles desde cualquier punto de la aplicación sin alterar el flujo principal.
...
![Diagrama de Clases Actualizado](app-service/src/main/resources/static/p3-images/complete-diagramatemplates.drawio.png)

### **Diagrama de Servicios**

![Diagrama de Servicios](app-service/src/main/resources/static/p3-images/service-diagram.drawio.png)
...
| Nº  |                                                                                                               Commits                                                                                                               |                                                                                                                       Files                                                                                                                       |
| :-: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|  1  |         [Add utility-service with Spring Boot setup, including PDF generation and REST endpoints.](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/commit/0bd5fd50205c9bd287b5d8d8f4b685c470e1cbe1)         |                                             [pom.xml](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/blob/0bd5fd50205c9bd287b5d8d8f4b685c470e1cbe1/utility-service/pom.xml)                                              |
|  2  | [Implement REST controllers, security services, and Docker infrastructure with comprehensive unit testing](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/commit/079a7a4fd40c45b0800bcfa9935dde1e836ecfd0) |            [MessageRestController.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/blob/079a7a4fd40c45b0800bcfa9935dde1e836ecfd0/app-service/src/main/java/es/urjc/ecomostoles/backend/controller/api/MessageRestController.java)            |
|  3  |                   [Implement DemandRestController with full CRUD operations for demands](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/commit/dfb58991be3614ce83f09ecab1ac840f28370e4f)                   | [DemandRestController.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/blob/dfb58991be3614ce83f09ecab1ac840f28370e4f/app-service/src/main/java/es/urjc/ecomostoles/backend/controller/api/DemandRestController.java) |
|  4  |                       [Implement authentication endpoints and JWT generation logic](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/commit/cce3dc5509e85c15bea12857d4cf0757cb6c59ce)                        |             [AuthService.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/blob/cce3dc5509e85c15bea12857d4cf0757cb6c59ce/app-service/src/main/java/es/urjc/ecomostoles/backend/security/AuthService.java)             |
|  5  |                  [Configure global OpenAPI security scheme for JWT Bearer authentication](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/commit/49592be2a5bf1c62c6a8a9a0592c8793d1450451)                  |                                             [ci.yml](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/blob/49592be2a5bf1c62c6a8a9a0592c8793d1450451/.github/workflows/ci.yml)                                              |

---

#### **Alumno 3 - Javier de la Casa Muñoz**

Durante el desarrollo de esta tercera práctica, mi responsabilidad principal ha recaído en el fortalecimiento del ecosistema de seguridad y la integración del cliente ligero. En primer lugar, he liderado la integración de Spring Security mediante una implementación moderna de JwtService, desarrollando desde cero un filtro de autenticación personalizado (OncePerRequestFilter). Este sistema permite la validación de tokens JWT y la inyección automática del contexto de seguridad en cada petición, garantizando un modelo de autenticación sin estado (stateless) robusto.

Asimismo, me he encargado de la convergencia entre el backend y el frontend, configurando las políticas de CORS necesarias para permitir la comunicación con una Single Page Application (SPA) desarrollada en Vanilla JS. En este cliente, he implementado de forma integral la lógica de gestión de tokens y el consumo de la API protegida. Complementariamente, he trabajado en la auditoría de seguridad de la API, identificando y resolviendo vulnerabilidades críticas de tipo IDOR (Insecure Direct Object Reference) y fallos en el control de acceso basado en roles, además de unificar el sistema de internacionalización de excepciones para mejorar la consistencia de las respuestas del servidor.

Finalmente, mi contribución se ha extendido al área de monitorización y calidad del servicio. He diseñado e implementado el panel de administración (dashboard) mediante nuevos controladores REST y configuraciones de seguridad específicas para la supervisión del sistema. Para asegurar la fiabilidad de la entrega, he expandido la colección de Postman con casos de prueba exhaustivos que cubren flujos de error, filtrado avanzado y exportación de documentos PDF. Por último, he optimizado la mantenibilidad del proyecto mediante la actualización del enrutamiento de servicios y la localización técnica de los comentarios del código fuente.

| Nº  |                                                                                                                                               Commits                                                                                                                                               |                                                                                                                          Files                                                                                                                          |
| :-: | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|  1  |           [Integrate spring security and jjwt with modern JwtService implementation and implement OncePerRequestFilter for JWT validation and context injection](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/commit/668f4cb902dd5b34557032b33dafeb13dbb4909d)           | [JwtAuthenticationFilter.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/blob/668f4cb902dd5b34557032b33dafeb13dbb4909d/app-service/src/main/java/es/urjc/ecomostoles/backend/security/jwt/JwtAuthenticationFilter.java) |
|  2  |                   [Configure CORS for frontend SPA integration and create Vanilla JS SPA client with JWT token management and protected API consumption](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/commit/ed083ca2b9b48e89ddde392b430e7da22817f1aa)                   |                                                [app.js](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/blob/ed083ca2b9b48e89ddde392b430e7da22817f1aa/frontend-client/app.js)                                                 |
|  3  | [Resolver vulnerabilidad IDOR en API REST y unificar idioma de excepciones and resolve IDOR and role-based vulnerabilities, update service routing, and localize comments](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/commit/ceb9f1cd2fb137b5852565815011974cb1384ea6) |        [SecurityConfig.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/blob/ceb9f1cd2fb137b5852565815011974cb1384ea6/app-service/src/main/java/es/urjc/ecomostoles/backend/security/config/SecurityConfig.java)         |
|  4  |                                            [Implement OfferRestController write operations with HTTP 201 and Location headers](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/commit/0a187cefec90efe3a640a8543bacadf64a204387)                                             |    [OfferRestController.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/blob/0a187cefec90efe3a640a8543bacadf64a204387/app-service/src/main/java/es/urjc/ecomostoles/backend/controller/api/OfferRestController.java)    |
|  5  |                                     [Implement admin dashboard UI, API controllers, and security configuration for system monitoring](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/commit/d734cfec093f486cce3bf06a4dca8db200c6d79a)                                      |   [ReportRestController.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/blob/d734cfec093f486cce3bf06a4dca8db200c6d79a/app-service/src/main/java/es/urjc/ecomostoles/backend/controller/api/ReportRestController.java)   |

---

#### **Alumno 4 - Daniel Nieto Díaz**

Durante el desarrollo de la Práctica 3, mi labor principal se ha centrado en la comunicación entre microservicios, la implementación de controladores REST avanzados y el aseguramiento de la calidad del software (QA). En el ámbito de la arquitectura distribuida, lideré la integración entre el `app-service` y el `utility-service` mediante el uso de clientes declarativos con **OpenFeign**, dotando al sistema de tolerancia a fallos mediante la implementación del patrón *Circuit Breaker* con **Resilience4j**. Asimismo, desarrollé la lógica y el endpoint REST encargado de la generación de los certificados documentales utilizando OpenPDF.

En la capa de la API, asumí la creación de los controladores `AgreementRestController` y `MessageRestController`, encargados de gestionar las transiciones de estado complejas del negocio, además de implementar los endpoints específicos para la subida, descarga y validación de activos multimedia (imágenes). Paralelamente, optimicé la capa de negocio refactorizando servicios clave como `AgreementService`, introduciendo el uso de *Streams* para mejorar el rendimiento algorítmico en el cálculo de métricas ambientales y flexibilizando las actualizaciones parciales de entidades.

Por último, en el área de Infraestructura y Calidad, garanticé la resiliencia del despliegue incorporando *Healthchecks* nativos en los contenedores Docker mediante llamadas `curl`. Además, elaboré los diagramas arquitectónicos del ecosistema y lideré la estabilización de la batería de pruebas de integración, corrigiendo problemas de integridad de datos en los flujos CRUD y validando operativamente los flujos de negocio críticos (Acuerdos, Smart Matching y Mensajería) junto con la parametrización final de la colección de Postman.

| Nº  |               Commits                |           Files           |
| :-: | :----------------------------------: | :-----------------------: |
|  1  | [feat(utility): implement REST endpoint for PDF generation](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/commit/5fad467e1b789ba0cd6627214f479d5822e1a95d) | [PdfGeneratorService.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/blob/5fad467e1b789ba0cd6627214f479d5822e1a95d/utility-service/src/main/java/es/urjc/ecomostoles/utility/service/PdfGeneratorService.java) |
|  2  | [feat(api): implement Agreement and Message REST controllers managing business state transitions and endpoints for updload and download of images](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/commit/ead80c2fce39348cdc6a4b36cbb103b29440a558) | [ImageRestController.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/blob/ead80c2fce39348cdc6a4b36cbb103b29440a558/app-service/src/main/java/es/urjc/ecomostoles/backend/controller/api/ImageRestController.java) |
|  3  | [feat(api and utility): implement OpenFeign client and Resilience4j circuit breaker for utility-service communication and implement REST endpoint for PDF generation using OpenPDF](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/commit/14813e5374c1485cf4f684c5fc02d9f455e46a1d) | [PdfGenerationService.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/blob/14813e5374c1485cf4f684c5fc02d9f455e46a1d/utility-service/src/main/java/es/urjc/ecomostoles/utility/service/PdfGenerationService.java) |
|  4  | [Test: Correcting data integrity and persistence in CRUD tests (Phase 2) and Successfully validate business flows (Agreements, Matching, Messaging) in Phase 3](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/commit/4e120412fc131f860e689738890b61a0566a0652) | [CompanyRestControllerTest.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/blob/4e120412fc131f860e689738890b61a0566a0652/app-service/src/test/java/es/urjc/ecomostoles/backend/controller/api/CompanyRestControllerTest.java) |
|  5  | [Refactor core business logic in Agreement and Message services for better performance using Streams. Hardened Docker infrastructure by implementing container health checks in docker-compose. Comprehensively updated REST API test suites for better clarity and edge-case coverage (RBAC/IDOR), alongside updates to the Postman collection and architecture diagrams.](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/commit/2191dbb8ed86d044748d22b2f2f2ef2f1dd91602) | [AgreementService.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/blob/2191dbb8ed86d044748d22b2f2f2ef2f1dd91602/app-service/src/main/java/es/urjc/ecomostoles/backend/service/AgreementService.java) |
