...
| Nº  |                                                                                 Commits                                                                                 |                                                                    Files                                                                    |
| :-: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------------------------------: |
|  1  |                      [Update README.md with detailed project description, entity definitions, user permissions, and system features](URL_commit_1)                      | [Archivo1](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-10/blob/59723ebf426ad6b05c2c5bfcf7a033e79b17bc3d/README.md) |
|  2  |                                                 [Add login and registration pages with Bootstrap styling](URL_commit_2)                                                 |                                                          [Archivo1](URL_archivo_2)                                                          |
|  3  |                                                 [Add login and registration pages with Bootstrap styling](URL_commit_3)                                                 |                                                          [Archivo1](URL_archivo_3)                                                          |
|  4  |                                                 [Add login and registration pages with Bootstrap styling](URL_commit_4)                                                 |                                                          [Archivo1](URL_archivo_4)                                                          |
|  5  |                                                 [Add login and registration pages with Bootstrap styling](URL_commit_4)                                                 |                                                          [Archivo1](URL_archivo_4)                                                          |
|  6  |                                    [Add mercado.html for offers display; include navigation, filters, and item cards](URL_commit_5)                                     |                                                          [Archivo2](URL_archivo_5)                                                          |
|  7  |                                 [Refactor CSS styles for improved readability and organization; add comments for clarity](URL_commit_3)                                 |                                                          [Archivo3](URL_archivo_3)                                                          |
